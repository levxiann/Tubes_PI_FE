...
@section('content')
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Add New Shop</h1>
                </div>
                ...
                <form method="POST" action="{{url('/shop/add')}}" class="user">
                    @csrf
                        <div class="form-group">
                            <input name="name" type="text" class="form-control form-control-user"
                                aria-describedby="nameHelp"
                                placeholder="Shop Name" @error('name') is-invalid @enderror value="{{old('name')}}" required>
                            @error('name')
                        ...
                        <div class="form-group">
                            <input name="location" type="text" class="form-control form-control-user"
                                aria-describedby="nameHelp"
                                placeholder="Shop Location" @error('location') is-invalid @enderror value="{{old('location')}}" required>
                            @error('location')
                                <p class="text-danger small">
                                    <strong>{{$message}}</strong>
                                </p>
